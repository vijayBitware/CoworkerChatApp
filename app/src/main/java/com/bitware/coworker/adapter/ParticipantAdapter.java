...
public class ParticipantAdapter extends RecyclerView.Adapter<ParticipantAdapter.ViewHolder> {
    ...
    public ParticipantAdapter(Context activity, JSONArray jsonArray) {
        this.list = jsonArray;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        group_id = object.optString("groupId");
        if (my_id.equalsIgnoreCase(object.optString("participantId"))) {
            String isAdmin = object.optString("isAdmin");
            if (isAdmin.equalsIgnoreCase("0")) {

                try {
                    amAdmin = false;
                    UserDetails.add_parti.setVisibility(View.GONE);
                    UserDetails.toolbar.getMenu().clear();
                    UserDetails.toolbar.inflateMenu(R.menu.group_menu_noadmin);
                }catch (Exception e)
                {
...
//                });
    ...
    private void showadmindialog(final String parti_id, final String created_by, final String joined_at) {
        ...
        make_admin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    UserDetails.makeadmin(parti_id, group_id, myContext, dialog, created_by, joined_at);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
    ...
    private void showremoveadmindialog(final String parti_id) {
        String from = SharedHelper.getKey(myContext, "my_zoe_id");
        final DBHandler dbHandler = new DBHandler(myContext);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    String isAdmin = list.optJSONObject(getAdapterPosition()).optString("isAdmin");
                    ...
                    if (!parti_id.equalsIgnoreCase(my_id)) {
                        if (!amAdmin) {
                            ...
                            if (isAdmin.equalsIgnoreCase("0")) {
                                ...
                                showremoveadmindialog(parti_id);
                            }
